...
class CPAlertVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if negativeAction?.title.contains("Delete") ?? false {
            negButton.setTitleColor(UIColor.red, for: .normal)
        } else if positiveAction?.title.contains("Delete") ?? false {
            posButton.setTitleColor(UIColor.red, for: .normal)
        }
    }
